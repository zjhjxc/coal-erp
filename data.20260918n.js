  ...
  if(typeof document!=="undefined" && document.getElementById){
    if(!document.getElementById("coalGlobalStyle")){
      ...
      st.textContent=[
        ...
        'table thead th{color:#22305c!important;font-weight:700;letter-spacing:.02em}',
        ...
        '.stat{border-radius:14px;padding:14px 16px;color:#fff;position:relative;overflow:hidden;box-shadow:0 8px 24px rgba(90,60,10,.28),inset 0 2px 0 rgba(255,255,255,.50),inset 0 -4px 0 rgba(0,0,0,.24),inset 0 -10px 18px rgba(0,0,0,.18)}',
        '.stat::after{content:"";position:absolute;right:-20px;top:-20px;width:70px;height:70px;background:rgba(255,255,255,.15);border-radius:50%}',
        '.stat-blue{background:linear-gradient(180deg,#6db3ff,#3b82f6 55%,#1e40af)}',
        '.stat-cyan{background:linear-gradient(180deg,#4adbe8,#06b6d4 55%,#0e7490)}',
        '.stat-green{background:linear-gradient(180deg,#5ce0b0,#10b981 55%,#0b7a5a)}',
        '.stat-emerald{background:linear-gradient(180deg,#6be6c4,#34d399 55%,#0f766e)}',
        '.stat-amber{background:linear-gradient(180deg,#ffc468,#f59e0b 55%,#b45309)}',
        '.stat-red{background:linear-gradient(180deg,#ff7a72,#ef4444 55%,#b91c1c)}',
        '.stat-violet{background:linear-gradient(180deg,#b79afc,#8b5cf6 55%,#5b21b6)}',
        '.stat-slate{background:linear-gradient(180deg,#8a98ac,#64748b 55%,#334155)}',
        ...
        'th{background:linear-gradient(180deg,#c3cdea,#93a7d6 55%,#6d80b8)!important;box-shadow:inset 0 2px 0 rgba(255,255,255,.6), inset 0 -2px 0 rgba(0,0,0,.12)}',
        'th, th *{color:#22305c!important;font-weight:700}'
      ].join("\n");
